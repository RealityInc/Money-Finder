const network={
  ...
  purpose:'Route autonomous software to the narrowest useful service while preserving buyer-controlled spending and independent settlement.',
  services:[
    {id:'machine-observer',name:'Machine Observer',canonical:'https://machineobserver.com',role:'Machine-economy observatory, source reliability, Agent-Native Web discovery, x402 best-practice intelligence, cross-domain transfer, and agent attention market.',manifest:'https://machineobserver.com/.well-known/agent.json',freeStart:['https://machineobserver.com/api/v1/briefing','https://machineobserver.com/api/v1/reliability','https://machineobserver.com/api/v1/agent-native-web'],paidCatalog:'https://machineobserver.com/api/x402/catalog'},
  ...
  handoffPolicy:{freeFirst:true,buyerControlsSpend:true,crossServiceAutoPayment:false,hiddenReferralCommission:false,independentSettlement:true,principalPolicyAlwaysWins:true}
};
